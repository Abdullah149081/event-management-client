...
import fiCheck from '@/assets/icon/fi-check.svg';
import outlined from '@/assets/icon/outlined-32-arrow-right.svg';

export const duotoneIcon = duotonePackage;
export const rocketIcon = duotoneRocketLaunch;
